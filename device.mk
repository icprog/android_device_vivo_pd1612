...
VENDOR_BLOBS ?= vendor/vivo/pd1612/pd1612-vendor.mk
$(call inherit-product-if-exists, $(VENDOR_BLOBS))

MTK_PROJECT_CONFIG ?= device/vivo/pd1612/ProjectConfig.mk
...
TARGET_OTA_ASSERT_DEVICE := pd1612,PD1612,vivo,Vivo,c239v55_dx
